...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('photos.index')" :active="request()->routeIs('photos.index')" wire:navigate>
                {{ __('My Photos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('photos.upload')" :active="request()->routeIs('photos.upload')" wire:navigate>
                {{ __('Upload Photo') }}
            </x-responsive-nav-link>
